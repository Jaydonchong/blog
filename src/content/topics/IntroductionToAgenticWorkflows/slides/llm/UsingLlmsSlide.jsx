  ...
  return (
    <div className="diag-above">
      ...
      <ul className="bullets">
        ...
        <li><span><span className="term">Encapsulated</span> — a closed environment</span></li>
        <li><span><span className="term">Response-only</span> — won't act first</span></li>
      </ul>
...
UsingLlmsSlide.meta = {
  ...
  notes: 'Consequences to draw on later: stateless means section 3 exists. Non-deterministic means you cannot test with one run. Encapsulated means everything it can reach, you handed it — nothing leaks in on its own, which is the whole tools section. Response-only means the loop is not a nice-to-have, it is the source of agency. Hallucination if asked: a completion engine always completes, so it rarely abstains.',
}
