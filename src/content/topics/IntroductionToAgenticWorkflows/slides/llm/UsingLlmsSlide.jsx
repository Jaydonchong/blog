...
UsingLlmsSlide.meta = {
  ...
  notes: 'Consequences to draw on later: stateless means section 3 exists. Non-deterministic means you cannot test with one run. Encapsulated means everything it can reach, you handed it — nothing leaks in on its own, which is the whole tools section, and it is also why the model never acts first: the loop is the source of agency. Hallucination if asked: a completion engine always completes, so it rarely abstains.',
}
