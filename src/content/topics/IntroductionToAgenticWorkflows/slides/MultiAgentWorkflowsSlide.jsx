function MultiAgentWorkflowsSlide() {
  return (
    <ul className="bullets">
      <li><span><span className="term">Swarming</span> — agents hand work off to each other</span></li>
      <li><span><span className="term">Orchestrating</span> — one coordinator delegates and collects</span></li>
      <li><span>The trade: less context per agent, more coordination</span></li>
    </ul>
  )
}
